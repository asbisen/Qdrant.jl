...
Base.@kwdef mutable struct QdrantOptimizersConfigDiff <: OpenAPI.APIModel
    ...
    function QdrantOptimizersConfigDiff(deleted_threshold, vacuum_min_vector_number, default_segment_number, max_segment_size, memmap_threshold, indexing_threshold, flush_interval_sec, max_optimization_threads, )
        OpenAPI.validate_property(QdrantOptimizersConfigDiff, Symbol("deleted_threshold"), deleted_threshold)
        OpenAPI.validate_property(QdrantOptimizersConfigDiff, Symbol("vacuum_min_vector_number"), vacuum_min_vector_number)
        OpenAPI.validate_property(QdrantOptimizersConfigDiff, Symbol("default_segment_number"), default_segment_number)
        OpenAPI.validate_property(QdrantOptimizersConfigDiff, Symbol("max_segment_size"), max_segment_size)
        OpenAPI.validate_property(QdrantOptimizersConfigDiff, Symbol("memmap_threshold"), memmap_threshold)
        OpenAPI.validate_property(QdrantOptimizersConfigDiff, Symbol("indexing_threshold"), indexing_threshold)
        OpenAPI.validate_property(QdrantOptimizersConfigDiff, Symbol("flush_interval_sec"), flush_interval_sec)
        OpenAPI.validate_property(QdrantOptimizersConfigDiff, Symbol("max_optimization_threads"), max_optimization_threads)
...
end # type QdrantOptimizersConfigDiff

const _property_types_QdrantOptimizersConfigDiff = Dict{Symbol,String}(Symbol("deleted_threshold")=>"Float64", Symbol("vacuum_min_vector_number")=>"Int64", Symbol("default_segment_number")=>"Int64", Symbol("max_segment_size")=>"Int64", Symbol("memmap_threshold")=>"Int64", Symbol("indexing_threshold")=>"Int64", Symbol("flush_interval_sec")=>"Int64", Symbol("max_optimization_threads")=>"Int64", )
OpenAPI.property_type(::Type{ QdrantOptimizersConfigDiff }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_QdrantOptimizersConfigDiff[name]))}

function check_required(o::QdrantOptimizersConfigDiff)
    true
end

function OpenAPI.validate_property(::Type{ QdrantOptimizersConfigDiff }, name::Symbol, val)
    if name === Symbol("deleted_threshold")
        OpenAPI.validate_param(name, "QdrantOptimizersConfigDiff", :format, val, "double")
    end
    if name === Symbol("vacuum_min_vector_number")
        OpenAPI.validate_param(name, "QdrantOptimizersConfigDiff", :format, val, "uint")
    end
    if name === Symbol("vacuum_min_vector_number")
        OpenAPI.validate_param(name, "QdrantOptimizersConfigDiff", :minimum, val, 0, false)
    end
    ...
    if name === Symbol("flush_interval_sec")
        OpenAPI.validate_param(name, "QdrantOptimizersConfigDiff", :format, val, "uint64")
    end
    if name === Symbol("flush_interval_sec")
        OpenAPI.validate_param(name, "QdrantOptimizersConfigDiff", :minimum, val, 0, false)
    end
